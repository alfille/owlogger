...
class Sensor(object):
    ...
    def __str__(self):
        ...
        Dprint( 'Sensor.__str__')
        return f"{str(self._connection)}{self._usePath} - {self._type}"
    ...
    def __repr__(self):
        ...
        Dprint( 'Sensor.__repr__')
        return f"Sensor(\"{self._usePath}\", server=\"{self._connection._server}\", port={self._connection._port})"
    ...
    def __eq__(self, other):
        ...
        Dprint( f"Sensor.__eq__({str(other)})" )
    ...
    def useCache(self, use_cache):
        ...
        Dprint( f"Sensor.useCache({str(use_cache)})" )
    ...
    def sensorList(self, names = [b'main', b'aux']):
        ...
        Dprint( f"Sensor.sensorList({str(names)})" )
    ...
    def find(self, **keywords):
        ...
        those passed in. By default, any matched attribute will yield a
